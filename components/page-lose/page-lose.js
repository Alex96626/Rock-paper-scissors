const renderContentLoseBlock = (container) => {
  ...
  const renderFigureNameRival = (container) => {
    ...
    const textFigureRival = figureNameRival.querySelector('.figure-name-rival__text');
    ...
    if (figurePlayer === 'scissors') {
      ...
      imageFigureRival.src = '/components/page-lose/images-page-lose/rock-win.png';
  ...
  const renderFigureNamePlayer = (container) => {
    ...
    const imageFigurePlayer = figureNamePlayer.querySelector('.image-figure-player');
    ...
    if (figurePlayer === 'scissors') {
      ...
      imageFigurePlayer.src = '/components/page-lose/images-page-lose/player-scissors-lose.png';
    ...
    if (figurePlayer === 'paper') {
      ...
      imageFigurePlayer.src = '/components/page-lose/images-page-lose/player-paper-lose.png';
